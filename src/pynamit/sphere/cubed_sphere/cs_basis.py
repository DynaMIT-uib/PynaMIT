...
class CSBasis(SurfaceOperators):
    ...
    def __init__(self, N=None):
        ...
        if N is not None:
            ...
            self.N = int(N)
            self.grid_geometry = CSGridGeometry.from_basis(self, self.N)
            self.arr_xi = self.grid_geometry.arr_xi
            self.arr_eta = self.grid_geometry.arr_eta
            self.arr_block = self.grid_geometry.arr_block
            self.arr_theta = self.grid_geometry.arr_theta
            self.arr_phi = self.grid_geometry.arr_phi
            self.g = self.grid_geometry.metric_tensor

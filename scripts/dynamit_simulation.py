...
i2d.set_conductance(hall_EUV, pedersen_EUV, lat = csp_grid.lat, lon = csp_grid.lon)
...
for t in np.arange(STEP, 600, STEP):
    ...
    if t <= 120:
        ...
        i2d.set_conductance(hall_aurora, pedersen_aurora, lat = csp_grid.lat, lon = csp_grid.lon)

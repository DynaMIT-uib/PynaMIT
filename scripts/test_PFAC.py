...
i2d = pynamit.I2D(Nmax, Mmax, Ncs, B0 = 'dipole', FAC_integration_parameters = {'steps':np.logspace(np.log10(RE + 110.e3), np.log10(7 * RE), 11)})
...
secsI = jparallel * i2d.sinI * i2d.csp.unit_area * i2d.RI**2 # SECS amplitudes are downward current density times area

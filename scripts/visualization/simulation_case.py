...
paxn2 = Polarplot(
    plt.subplot2grid((4, 62), (1, 2 + 20 * 0), colspan=20, projection=a.get_global_projection())
)
paxs2 = Polarplot(
    plt.subplot2grid((4, 62), (1, 2 + 20 * 1), colspan=20, projection=a.get_global_projection())
)
paxn3 = Polarplot(
...
a.plot_conductance(gax2, region="global", levels=conductance_levels, extend="both").set_edgecolor(
    "face"
)
...
a.plot_conductance(paxn2, region="north", levels=conductance_levels, extend="both").set_edgecolor(
    "face"
)

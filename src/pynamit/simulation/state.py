...
class State(object):
    ...
    def initialize_constraints(self):
        ...
        if self.connect_hemispheres:
            ...
            self.G_m_imp_to_jr[self.ll_mask] += (self.jr_cp_basis_evaluator.scaled_G(self.m_imp_to_jr) * (-self.cp_b_evaluator.e3r / self.b_evaluator.e3r).reshape((-1, 1)))[self.ll_mask]

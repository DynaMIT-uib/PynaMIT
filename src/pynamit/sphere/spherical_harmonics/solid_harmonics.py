...
class SolidHarmonics:
    ...
    PynaMIT follows the geomagnetic scalar-potential convention
    ...
    PynaMIT stores poloidal coefficients ``m_nm`` for which the radial
    ...
    regular and irregular shifts also apply directly to PynaMIT

...
plt.savefig('equations_fig0.png', dpi = 250)
...
plt.savefig('equations_fig1.png', dpi = 250)
...
ax.text(x[15] * (RI + 1 ), (RI + 1 ) * np.cos(a[15]), r'$\mathbf{E} = (\Sigma_P\mathbf{j}\times\hat{\mathbf{r}} + \Sigma_H\mathbf{j})/(\Sigma_P^2 +\Sigma_H^2)$' , rotation = -np.rad2deg(a[15]), ha = 'left', va = 'center', size = textsize, bbox=dict(facecolor='white', edgecolor='none', pad = 0))
ax.text(x[40] * (RI + 1 ), (RI + 1 ) * np.cos(a[40]), r'$\mathbf{j}_S = \hat{\mathbf{r}} \times (\mathbf{B}^+ - \mathbf{B}^-)/\mu_0$' , rotation = -np.rad2deg(a[40]), ha = 'left', va = 'center', size = textsize, bbox=dict(facecolor='white', edgecolor='none', pad = 0))
plt.savefig('equations_fig2.png', dpi = 250)

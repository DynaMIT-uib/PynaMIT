...
class BGeometry:
    ...
    @property
    def e1r(self):
        " Radial component of the first basis vector."
        return self.basevectors[3][0]

    @property
    def e1t(self):
        " Theta component of the first basis vector."
        return self.basevectors[3][1]

    @property
    def e1p(self):
        " Phi component of the first basis vector."
        return self.basevectors[3][2]

    @property
    def e2r(self):
        " Radial component of the second basis vector."
        return self.basevectors[4][0]

    @property
    def e2t(self):
        " Theta component of the second basis vector."
        return self.basevectors[4][1]

    @property
    def e2p(self):
        " Phi component of the second basis vector."

...
def test_2d_dipole_pfac_hc(regression_approx):
    """Test 2D simulation with dipole, PFAC, and HC."""
    # Arrange.
    expected_coeff_norm = 8.959217334602744e-09
    expected_coeff_max = 1.6926699363860244e-09
    expected_coeff_min = -3.7848736111753895e-09

...
def run_pynamit(
    ...
    settings_kwargs = dict(
        ...
        steady_state_regularization_lambda=steady_state_regularization_lambda,
        ...
        induction_null_diagnostics=induction_null_diagnostics,
        induction_null_svd_rtol=induction_null_svd_rtol,

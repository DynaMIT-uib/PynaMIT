...
def debugplot(i2d, title = None, filename = None, noon_longitude = 0):
    ...
    FAC = (plt_i2d_evaluator.scaled_G(1 / plt_b_evaluator.br.reshape((-1, 1)))).dot(i2d.state.B_imp.coeffs * i2d.state.B_imp_to_Jr)
    jr_mod = plt_i2d_evaluator.G.dot(i2d.state.B_imp.coeffs * i2d.state.B_imp_to_Jr)

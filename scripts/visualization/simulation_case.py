...
gax1 = plt.subplot2grid((4, 62), (0, 2 + 20*2), colspan = 20, projection = a.get_global_projection())
gax2 = plt.subplot2grid((4, 62), (1, 2 + 20*2), colspan = 20, projection = a.get_global_projection())
gax3 = plt.subplot2grid((4, 62), (2, 2 + 20*2), colspan = 20, projection = a.get_global_projection())
gax4 = plt.subplot2grid((4, 62), (3, 2 + 20*2), colspan = 20, projection = a.get_global_projection())


paxn1 = Polarplot( plt.subplot2grid((4, 62), (0, 2 + 20*0), colspan = 20, projection = a.get_global_projection()))
paxs1 = Polarplot( plt.subplot2grid((4, 62), (0, 2 + 20*1), colspan = 20, projection = a.get_global_projection()))
paxn2 = Polarplot( plt.subplot2grid((4, 62), (1, 2 + 20*0), colspan = 20, projection = a.get_global_projection()))
paxs2 = Polarplot( plt.subplot2grid((4, 62), (1, 2 + 20*1), colspan = 20, projection = a.get_global_projection()))
paxn3 = Polarplot( plt.subplot2grid((4, 62), (2, 2 + 20*0), colspan = 20, projection = a.get_global_projection()))
paxs3 = Polarplot( plt.subplot2grid((4, 62), (2, 2 + 20*1), colspan = 20, projection = a.get_global_projection()))
paxn4 = Polarplot( plt.subplot2grid((4, 62), (3, 2 + 20*0), colspan = 20, projection = a.get_global_projection()))
paxs4 = Polarplot( plt.subplot2grid((4, 62), (3, 2 + 20*1), colspan = 20, projection = a.get_global_projection()))
...
a.plot_electric_potential(            paxn4, region = 'north', colors = 'black', levels = np.r_[-201.5:202:3]*1e3)
...
plt.subplots_adjust(top = .96, bottom = .015, left = .095, right = .985, hspace = .2, wspace = .145)

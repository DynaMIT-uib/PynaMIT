...
TAPERING_TIME = 200. # period during which to ramp up amplitude of oscillations before peak
NUMBER_OF_OSCILLATIONS = 2 # how many oscillations to simulate after tapering
